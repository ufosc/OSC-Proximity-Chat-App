...
export const SettingsItem = ({id, title, type, setter, data}: SettingsProps) => (
    ...
    <TouchableOpacity onPress={() => {}}>
        <View style={styles.row}>
            <Text style={styles.rowTitle}>{title}</Text>
                {type === 'toggle' && (
                    <Switch
                        onValueChange={(val) => { setter({ ...data, [id]: Boolean(val) }); }} // Convert val to boolean using Boolean() function
